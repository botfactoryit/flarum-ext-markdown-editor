...
export default class EditorPage extends Component {
    ...
    init() {
        ...
        this.settingsPrefix = 'botfactoryit.mdeditor';
            ...
            <div className='container'>
                <form onsubmit={this.onsubmit.bind(this)}>
                    <fieldset className='EditorPage-preferences'>
                        <legend>{app.translator.trans('botfactoryit-mdeditor.admin.labels.preferences.title')}</legend>
                        <label>{app.translator.trans('botfactoryit-mdeditor.admin.labels.preferences.symbols')}</label>
                    ...
                    {Button.component({
                        ...
                        children: app.translator.trans('botfactoryit-mdeditor.admin.buttons.save'),
